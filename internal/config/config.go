...
func GetConfig() (*Configuration, error) {
	...
	v.SetDefault("stackstate.tls_skip_verify", true)
	v.SetDefault("stackstate.tls_cert_file", "")
	v.SetDefault("stackstate.tls_key_file", "")
	v.SetDefault("stackstate.tls_ca_file", "")
